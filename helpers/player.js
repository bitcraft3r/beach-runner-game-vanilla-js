...
export class Player {
    ...
    update(input, deltaTime){
        ...
        // horizontal movement
        this.x += this.speed;
        if (input.includes('ArrowRight') || input.includes('swipe right') && this.currentState !== this.states[4]) this.speed = this.maxSpeed;
        else if (input.includes('ArrowLeft') || input.includes('swipe left') && this.currentState !== this.states[4]) this.speed = -this.maxSpeed;
        else this.speed = 0;
